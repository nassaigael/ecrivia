// src/components/Instructions.jsx (amélioré avec icônes Lucide pour les étapes)
...
const Instructions = () => {
  return (
    <div className="mt-8 bg-blue-50 rounded-2xl p-6 border border-blue-200">
      <h3 className="text-lg font-semibold text-blue-900 mb-3">Comment utiliser EmailCraft AI avec Puter</h3>
